                               ...
                               <td class="title-20 pb-15"
                                ...
                                <multiline>
                                 <strong>Order
                                  <span
                                   class="c-purple"
                                   style="color:#9128df;">#123456</span></strong>
                                </multiline>
                               </td>
                              </tr> -->
                                                                                                                        <tr>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            <td class="text-16"
                                                                                                                                ...
                                                                                                                                <multiline>
                                                                                                                                    {{ $user->name . ' ' . $user->last_name }}
                                                                                                                                    <br />
                                                                                                                                    {{ $sale->sale_address->province->name . ' / ' . $sale->sale_address->city->name . ' / ' . $sale->sale_address->parish->name }}
                                                                                                                                    <br />
                                                                                                                                    {{ $sale->sale_address->main_street . ' - ' . $sale->sale_address->secondary_street . ' - ' . $sale->sale_address->number }}
                                                                                                                                </multiline>
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <th class="column-top"
                                                                                                                        ...
                                                                                                                        <div class="fluid-img"
                                                                                                                            ...
                                                                                                                            <a href="#"
                                                                                                                                target="_blank"><img
                                                                                                                                    src="{{ env('APP_URL') . '/storage/' . $sale_detail->product->image }}"
                                                                                                                                    border="0"
                                                                                                                                    width="230"
                                                                                                                                    height="180"
                                                                                                                                    editable="true"
                                                                                                                                ...
                                                                                                                                <table
                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                        ...
                                                                                                                                        <td class="img mw-15 pt-10"
                                                                                                                                            style="font-size:0pt; line-height:0pt; text-align:left; padding-top: 10px;">
                                                                                                                                        </td>
