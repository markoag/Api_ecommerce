...
<body>
    ...
    <div class="web-container page-break">
                ...
                <tbody>
                    <tr>
                        <td style="padding: 0 !important;border-bottom:none;">
                            <img style="height: 75px;background:black;"
                                src="{{ public_path('Logo_bajo.jpg') }}">
                        </td>
                        <td style="padding: 0 !important;border-bottom:none;">
                            <br>
                            <small>Tel. 3-702-677</small>
                            <br>
                            <small>Km. 6,5 via Daule Lotizacion Santa <br> Adriana Mz. 25 Solar 11 090505 <br>
        ...
        <table class="invoice-info-container">
            <tr>
                <td>
                    N° VENTA: <strong>#{{ $sale->n_transaction }}</strong>
                </td>

                <td>
                    FECHA VENTA: {{ $sale->created_at->format('d/m/Y h:i A') }}
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="">
                    ...
                    <br>
                    <br>
                    CLIENTE: {{ $sale->user->name . ' ' . $sale->user->last_name }}
                </td>
                <td>
                    DOC. {{ $sale->id }}
                </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if ($item->discount > 0)
                                ...
                                {{ $item->type_discount == 1 ? $item->discount . '%' : '$' . $item->discount }}
                                <br>
                                @if ($item->type_campaign)
                                    <strong>Campaña:</strong> {{ $item->code_discount }}
                                @else
                                    <strong>Cupón:</strong> {{ $item->code_coupon }}
                                @endif
                            @endif
                        </td>
        ...
        <table class="line-items-container has-bottom-border">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="large">{{ $sale->created_at->format('d/m/Y h:i A') }}</td>
